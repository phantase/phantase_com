...
var destinationUrl = "./admin/gallery/processupload/";
var destinationPath = document.getElementById('path');
...
(function(){
    ...
    function drawProgress(progress) {
        ...
        context.beginPath();
        context.strokeStyle = '#109500';
        context.fillStyle = '#109500';
    ...
    function uploadFile(file, status) {
        ...
        formData.append('mypath', destinationPath.value); 
        xhr.send(formData);
    }
