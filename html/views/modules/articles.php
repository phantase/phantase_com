								...
								<!-- Feature <?php echo $article['article_id']; ?> -->
									<section>
										<a href="<?php echo $article['article_date_publie_html']; ?>/<?php echo $article['article_html']; ?>/" class="bordered-feature-image">
											<img src="https://cdn.phantase.net/article//<?php echo $article['article_html']; ?>_cover.jpg" alt="<?php echo $article['article_titre']; ?>" title="<?php echo $article['article_titre']; ?>" />
